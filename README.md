...
```javascript
import resolveParentPathBy from 'https://cdn.jsdelivr.net/gh/stdlib-js/fs-resolve-parent-path-by@v0.2.3-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { sync } from 'https://cdn.jsdelivr.net/gh/stdlib-js/fs-resolve-parent-path-by@v0.2.3-deno/mod.js';
```
